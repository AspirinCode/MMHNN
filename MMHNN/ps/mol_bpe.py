...
from ps.utils.chem_utils import smi2mol, mol2smi, get_submol
from ps.utils.chem_utils import cnt_atom, MAX_VALENCE
from ps.utils.logger import print_log
...
class Tokenizer:
    ...
    def tokenize(self, mol):
        ...
        # mol = Molecule(smiles, group_idxs, self.kekulize)
        # return group_idxs, mol
        return group_idxs, res
...
def parse():
    ...
    parser.add_argument('--data', type=str, required=True,default='/home/ljh/remote/PS_VAE/ps/data/toy_set.txt', help='Path to molecule corpus')
    parser.add_argument('--vocab_size', type=int, default=500, help='Length of vocab')
    parser.add_argument('--output', type=str, required=True, default='/home/ljh/remote/PS_VAE/ps/vocabulary.txt',help='Path to save vocab')
