...
class DrugDataset(Dataset):
    ...
    def collate_fn(self, batch):
        ...
        for h, t, r in batch:
            #print(id_smiles_dic[h])

            neg_heads, neg_tails = self.__normal_batch(h, t, r, self.neg_ent)
            pos_i = [id_smiles_dic[h],id_smiles_dic[t],0,r]
            for neg_h in neg_heads:
                neg_i = [id_smiles_dic[neg_h],id_smiles_dic[t],1,r]

            for neg_t in neg_tails:
                #r = torch.LongTensor(r)
                neg_i = [id_smiles_dic[h],id_smiles_dic[neg_t],1,r]
